...
const Navbar = () => {
  ...
  const farmerItems = [
    ...
    { path: '/consultations', label: 'Experts', icon: Users },
  ];
          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-3">
              ...
              {user && (
                <button
                  onClick={handleLogout}
                  className="hidden sm:flex items-center space-x-2 px-3 py-2.5 bg-red-50 dark:bg-red-900/20 text-red-600 dark:text-red-400 hover:bg-red-100 dark:hover:bg-red-900/30 rounded-xl transition-all duration-200 group"
                  title="Logout"
                >
                  <LogOut size={16} />
